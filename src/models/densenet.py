...
def construir_modelo_densenet(num_classes_disease, num_classes_plant, capas_congeladas=20, dropout=0.5):
    """Construye un modelo basado en DenseNet121 con dos salidas."""
